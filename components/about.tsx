  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        I obtained certain skills that were impossible(at first) to gain. 
        ...
        <span className="font-medium">part time position</span> as a junior web developer or a data Analyst.
      </p>
      ...
      <p className="mb-3">
        ...
        my ignorant mind, thus, I am currently into learning my way to my own financial freedom, which will surely help myself and people around me.
      </p>
